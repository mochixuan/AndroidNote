...
public class CryptoObjectHelper {
    ...
    private final String ENCRYPTION_PADDING = KeyProperties.ENCRYPTION_PADDING_PKCS7;
    private final String TRANSFORMATION = KEY_ALGORITHM + "/" + BLOCK_MODE + "/" + ENCRYPTION_PADDING;
    private final KeyStore _keystore;

    public CryptoObjectHelper(String packageName) throws Exception {
        KEY_NAME = packageName;
