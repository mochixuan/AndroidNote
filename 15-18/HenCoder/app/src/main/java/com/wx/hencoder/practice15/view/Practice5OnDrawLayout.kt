...
class Practice5OnDrawLayout : LinearLayout {
    ...
    inner class Pattern {
        ...
        init {
            ...
            mSpots?.add(Spot(0.24f, 0.3f, 0.026f))
            mSpots?.add(Spot(0.60f, 0.4f, 0.067f))
            mSpots?.add(Spot(0.38f, 0.60f, 0.067f))
            mSpots?.add(Spot(0.5f, 0.78f, 0.083f))
        }
