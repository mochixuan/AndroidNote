...
class ComplexRecyclerViewActivity : BaseActivity() {
    ...
    fun getModelThreeData(): List<ModelThree> {
        ...
        modelThresss.add(ModelThree("火影忍者","\t\t这是一个忍者的世界.从小身上封印着邪恶的九尾妖狐,鸣人受尽了村人的冷落,只是拼命用各种恶作剧试图吸引大家的注意力.", intArrayOf(R.mipmap.ic_qsmy_1)))
        modelThresss.add(ModelThree("东京食尸鬼","\t\t蔓延着一种吞食死尸的怪人,人们称之为食尸鬼(喰种)",intArrayOf(R.mipmap.ic_qsmy_2)))
        modelThresss.add(ModelThree("斩赤红之瞳","\t\t少年剑士塔兹米为了解救一座贫穷的村子和伙伴一起渠道帝都打拼",intArrayOf(R.mipmap.ic_qsmy_3)))
        ...
        modelThresss.add(ModelThree("银魂","\t\t作为以SF时代剧为体裁而创作的漫画，也是新人作者空知英秋的首部连载作品",intArrayOf(R.mipmap.ic_qsmy_6)))
        modelThresss.add(ModelThree("城市猎人","\t\t前作为1983年北条司本人的短篇作品《城市猎人XYZ》",intArrayOf(R.mipmap.ic_qsmy_7)))
        modelThresss.add(ModelThree("神奇宝贝","\t\t皮卡丘已成功打入全世界数十个国家，成为世界闻名的卡通形象和日本的国民动画",intArrayOf(R.mipmap.ic_qsmy_8)))
        modelThresss.add(ModelThree("网球王子","\t\t在漫画被改编成动画片播出后，日本一度掀起了网球热潮",intArrayOf(R.mipmap.ic_qsmy_9)))
        modelThresss.add(ModelThree("蜡笔小新","\t\t蜡笔小新受欢迎程度，可以由故事发生地崎玉县春日市采纳了他作为宣传人物而得知。",intArrayOf(R.mipmap.ic_qsmy_10)))
