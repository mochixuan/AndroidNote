...
public class Hack {
    ...
    static final String ADB_PATH = "F:/AndroidStudio/sdk/platform-tools/adb";

    /**
     * 弹跳系数，现在已经会自动适应各种屏幕，请不要修改。
     */
    //小米note3
    //static final double JUMP_RATIO = 1.424f;
    
    //小米6
    static final double JUMP_RATIO = 1.418f;
    
    //乐视2
    //static final double JUMP_RATIO = 1.320f;
    
    //魅族note3
    //static final double JUMP_RATIO = 1.36f;
