...
public abstract class WDividerItemDecoration extends RecyclerView.ItemDecoration {

    private Paint mPaint;

    private Context context;

    public WDividerItemDecoration(Context context) {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount1; i++) {
            ...
            WDivider divider = getDivider(itemPosition);
    ...
    public abstract WDivider getDivider(int itemPosition);
